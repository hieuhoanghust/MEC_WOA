...
function [BWOA_result, WOA_result, time] = BWOA2(functionName_, doTol, UEs, BS, UE_BS, fobj_bwoa, fobj_woa, fobj_woa_dl, h2h, params, var) 
    eta = var.eta;
 ...
 %           display([k fitbwoa score_bwoa leader_score_bwoa]);
     ...
     %           fprintf('old_time for condition 2: %i', t1);
                ...
                if (strcmp(functionName_,'ARJOA') || strcmp(functionName_, 'WOA_SIC_MEC')|| strcmp(functionName_, 'IOJOA')|| strcmp(functionName_, 'OFDMA'))
                    if N_ul > 0
                        [WOA_rs, pos_woa, ~, cci_SBS_temp] = WOA(noSearchAgents, ...
            ...
            if fitness >= leader_score_bwoa
                ...
                if strcmp(functionName_, 'WOA_SIC_MEC')
                    cci_SBS = cci_SBS_temp;
                end
