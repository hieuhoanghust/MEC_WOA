...
params.noRealizations = 1; %10; %200
...
% save('scriptN_results\resp_result\Script_N.mat', 'ALCA','WOA_BWOA', ...
%      "IWOA_BWOA", "PSO_BWOA", "ARJOA", "IOJOA", "OFDMA",'NoUsers', 'noRealizations')

save('scriptN_results\resp_result\Script_N.mat',...
      'WOA_BWOA',"IWOA_BWOA", "PSO_BWOA",'NoUsers')
