...
params.noBSs   = noBSs;
params.noSearchAgents = 20;
params.maxIter = 800;

params.noRealizations = 5; %10; %200
...
save('scriptN_results\resp_result\Script_N_ALCA_10Real.mat', 'ALCA','NoUsers', 'noRealizations')
