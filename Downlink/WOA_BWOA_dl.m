...
function [leader_score_bwoa, leader_pos_bwoa, leader_pos_woa, conver_curve, conver_curve_woa, no_WOA_run, time] = WOA_BWOA_dl(functionName, noSearchAgents, noUsers, noSubcs, noBSs, UE_BS, maxIter, fobj_bwoa, P_SBS_min, P_SBS_max, fobj_woa)
...
%            fprintf('SearchAgent no %i/%i\n', nSA, noSearchAgents)
 ...
 %           fprintf('old_time for condition 2: %i', t1);
            ...
            [WOA_rs, pos_woa, ~] = WOA_dl(noSearchAgents, ...
